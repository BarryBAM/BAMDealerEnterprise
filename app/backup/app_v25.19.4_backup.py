...
(function(){{
 ...
 function moveBottomPanels(){{
  var salesPanel=document.getElementById('bam-sale-paperwork');
  var deletePanel=document.getElementById('bam-delete-vehicle');
  var footer=document.querySelector('footer');
  var parent=(footer && footer.parentElement) ? footer.parentElement : document.body;
  if(salesPanel) parent.insertBefore(salesPanel, footer || null);
  if(deletePanel) parent.insertBefore(deletePanel, footer || null);
 }}
 function initVehicleActions(){{addTopActions();moveBottomPanels();}}
 if(document.readyState==='loading')document.addEventListener('DOMContentLoaded',initVehicleActions);else initVehicleActions();
}})();
</script>"""
