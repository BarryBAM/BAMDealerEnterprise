...
if(googleMarketBtn){
  googleMarketBtn.addEventListener('click',()=>{
    ...
    if(asset==='Boat'){
      ...
      parts.push('boat for sale Australia');
    }else{
      if(value('odometer_km')) parts.push(value('odometer_km')+' km');
      parts.push(asset.toLowerCase(),'for sale Australia','Carsales Gumtree dealer private');
    }
